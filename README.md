...
AHKforge allows you to quickly create hotkeys, hotstrings, key remaps, and "send text" actions without writing AHK code manually.
...
- **Import & Edit** existing scripts generated by AHKforge
...
Download the latest release from the [GitHub Releases](https://github.com/insmnaxd/AHKforge/releases) page.

AHKforge is built for Windows. AutoHotkey v1 or v2 is required, matching the version selected in the application.
...
Use **Open existing .ahk file** to continue editing a script previously created by AHKforge. Unsupported or manually altered blocks may be skipped during import.
...
AHKforge is licensed under the [MIT License](./LICENSE).
